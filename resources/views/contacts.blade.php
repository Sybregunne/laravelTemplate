<x-app-layout>
    ...
    <section class="py-5">
        <div class="container px-md-5">
            <div class="row mb-4">
                <div class="col-md-10 text-center mx-auto"><span class="badge bg-light rounded-pill p-2 mb-3 px-3">Contact
                        us</span>
                ...
                <div class="col-auto col-md-4 col-xl-3">
                    <div class="d-flex flex-row justify-content-start align-items-center flex-wrap">
                        <div class="d-flex align-items-center p-3">
                            <div class="fs-4 lh-1 text-white bg-primary rounded-circle p-3"><svg class="bi bi-telephone"
                        ...
                        <div class="d-flex align-items-center p-3">
                            <div class="fs-4 lh-1 text-white bg-primary rounded-circle p-3"><svg class="bi bi-envelope"
                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        <div class="d-flex align-items-center p-3">
                            <div class="fs-4 lh-1 text-white bg-primary rounded-circle p-3"><svg class="bi bi-pin"
                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16">
                                    <path
                    ...
                    <div class="accordion accordion-flush mx-auto" role="tablist">
                        <div class="accordion-item">
                            <h2 class="accordion-header" role="tab"><button class="accordion-button" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#" aria-expanded="true"> What is Brand?
                                </button></h2>
                            <div class="accordion-collapse collapse show item-1" role="tabpanel">
                                <div class="accordion-body">
                                    <p class="mb-0">Lorem ipsum placerat sed phasellus suspendisse, phasellus ultrices
                                        aliquam scelerisque. Proin vestibulum dui vehicula consectetur.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed"
                                    type="button" data-bs-toggle="collapse" data-bs-target="#" aria-expanded="false">
                                    Do you offer a free trial? </button></h2>
                            <div class="accordion-collapse collapse item-2" role="tabpanel">
                                <div class="accordion-body">
                                    <p class="mb-0">Lorem ipsum placerat sed phasellus suspendisse, phasellus
                                        ultrices aliquam scelerisque. Proin vestibulum dui vehicula consectetur.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed"
                                    ...
                                    aria-expanded="false"> Can I cancel my subscription at any time? </button></h2>
