                ...
                <div class="d-flex flex-fill justify-content-center align-items-center">
                    <div class="w-100 max-w-320">
                        <form class="d-flex flex-column gap-3">
                            ...
                            <div class="mb-3"><label class="form-label small fw-medium"
                                    for="email">Email</label><input class="form-control" type="email"
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-2"><label
                                        ...
                                        class="ms-auto small" href="#">Forgot your password?</a></div><input
                            ...
                            <div class="text-center small"><span> Don't have an account? </span><a href="#">Sign
                                    up</a></div>
                        </form>
                    </div>
                </div>
