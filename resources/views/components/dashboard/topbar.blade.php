                    <div
                        class="d-flex flex-column justify-content-between flex-xl-row-reverse align-items-xl-start pt-3 mb-3 px-0 border-bottom bg-body px-3 px-md-4 sticky-top">
                        <div class="d-flex align-items-center mb-3 mb-xl-0">
                            ...
                            <div class="theme-switcher dropdown" data-bs-adapt-icon="true"
                                ...
                                <div class="dropdown-menu dropdown-menu-end"><a
                                        ...
                                        </svg>Light </a><a class="dropdown-item d-flex align-items-center"
                            ...
                            <div class="dropdown">
                                <button class="btn dropdown-toggle border-0 p-2" data-bs-toggle="dropdown"
                                    aria-expanded="false" type="button">
                                    <img class="object-fit-cover border rounded-circle"
                                        src="/assets/img/team/avatar2.jpg" width="32" height="32">
                                </button>
                                <div class="dropdown-menu dropdown-menu-end shadow">
                                    <a class="dropdown-item" href="{{ route('profile') }}">
                                        <svg class="bi bi-person me-2" xmlns="http://www.w3.org/2000/svg" width="1em"
                                            height="1em" fill="currentColor" viewBox="0 0 16 16">
                                            <path
                                                d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z">
                                            </path>
                                        </svg>&nbsp;Profile</a>
                                    <a class="dropdown-item" href="#"><svg class="bi bi-gear me-2"
                                            xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            fill="currentColor" viewBox="0 0 16 16">
                                            <path
