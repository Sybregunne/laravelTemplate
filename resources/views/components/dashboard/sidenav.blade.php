            <div class="col bg-body p-0 px-md-2">
                <div class="offcanvas-md offcanvas-end sticky-md-top" tabindex="-1" id="sidebar">
                    <div class="offcanvas-body position-relative flex-column vh-100"><button
                            class="btn-close position-absolute top-0 end-0 d-md-none m-4" type="button" aria-label="Close"
                            data-bs-dismiss="offcanvas" data-bs-target="#sidebar"></button>
                        <div class="w-100 pt-3">
                            <a class="text-decoration-none link-body-emphasis d-inline-flex align-items-center ms-3"
                                href="#"><svg class="bi bi-circle-square fs-5 me-2"
                            ...
                            <a class="btn btn-primary d-flex justify-content-center align-items-center m-3"
                        ...
                        <div class="w-100 overflow-y-auto">
                            <div class="w-100 h-100">
                                <ul class="nav flex-column overflow-y-auto">
                                    <li class="nav-item"><a
                                            class="nav-link {{ Route::is('dashboard') ? 'active' : '' }}"
                                            href="{{ route('dashboard') }}"><svg class="bi bi-speedometer2 me-2"
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#"><svg
                                                class="bi bi-list-task me-2" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#"><svg
                                                class="bi bi-bar-chart me-2" xmlns="http://www.w3.org/2000/svg"
                                                width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                                <path
                                                    d="M4 11H2v3h2zm5-4H7v7h2zm5-5v12h-2V2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1z">
                                                </path>
                                            </svg>Analytics</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ route('projects') }}"><svg
                                                class="bi bi-folder me-2" xmlns="http://www.w3.org/2000/svg"
                                                width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                                <path
                                    ...
                                    <li class="nav-item"><a class="nav-link" href=""><svg
                                                class="bi bi-people me-2" xmlns="http://www.w3.org/2000/svg"
                                                width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                                <path
                                ...
                                <div class="mt-4">
                                    <h6 class="text-muted ps-3 small">Documents</h6>
                                    <ul class="nav flex-column">
                                        <li class="nav-item"><a class="nav-link" href="#"><svg
                                                    class="bi bi-database me-2" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div class="collapse" id="collapse-1">
                                                    <ul class="nav ms-3">
                                                        <li class="nav-item w-100"><a class="nav-link"
                                                                href="#"><svg class="bi bi-calendar me-2"
                                                                    xmlns="http://www.w3.org/2000/svg" width="1em"
                                                        ...
                                                        <li class="nav-item w-100"><a class="nav-link"
                                                                href="#"><svg class="bi bi-ticket me-2"
                                                                    xmlns="http://www.w3.org/2000/svg" width="1em"
                                                                    height="1em" fill="currentColor"
                                                                    viewBox="0 0 16 16">
                                                                    <path
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#"><svg
                                                    class="bi bi-gear me-2" xmlns="http://www.w3.org/2000/svg"
                                                    width="1em" height="1em" fill="currentColor"
                                                    viewBox="0 0 16 16">
                                                    <path
