<x-dash-layout>
    <x-slot name="title">Projects - Brand</x-slot>
            ...
            <div class="col-12">
                <div class="card">
                    <div
                        ...
                        <h5 class="fw-bold w-100 mb-3 mb-xl-0">Recent Projects</h5>
                    ...
                    <div class="card-body">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="p-3"><a
                                                ...
                                                href="{{ route('project') }}">
                                                <div>
                                                    <p class="fw-bold mb-0">Website Redesign</p><small
                                                        class="text-secondary d-block">Marketing Team</small>
                                                </div>
                                            </a></td>
                                    ...
                                    <tr>
                                        <td class="p-3"><a
                                                ...
                                                href="#">
                                                <div>
                                                    <p class="fw-bold mb-0">Mobile App Development</p><small
                                                        class="text-secondary d-block">Development Team</small>
                                                </div>
                                            </a></td>
                                        <td><span class="badge bg-light d-inline-flex gap-1"><svg
                                    ...
                                    <tr>
                                        <td class="p-3"><a
                                                ...
                                                href="#">
                                                <div>
                                                    <p class="fw-bold mb-0">Brand Identity Refresh</p><small
                                                        class="text-secondary d-block">Design Team</small>
                                                </div>
                                            </a></td>
                                        <td><span class="badge bg-light d-inline-flex gap-1"><svg
                                                    class="icon icon-tabler icon-tabler-loader"
                                    ...
                                    <tr>
                                        <td class="p-3"><a
                                                ...
                                                href="#">
                                                <div>
                                                    <p class="fw-bold mb-0">E-commerce Platform</p><small
                                                        class="text-secondary d-block">Product Team</small>
                                                </div>
                                            </a></td>
                                        <td><span class="badge bg-light d-inline-flex gap-1"><svg
                                                    class="icon icon-tabler icon-tabler-loader"
                                    ...
                                    <tr>
                                        <td class="p-3"><a
                                                ...
                                                href="#">
                                                <div>
                                                    <p class="fw-bold mb-0">CRM Integration</p><small
                                                        class="text-secondary d-block">Sales Team</small>
                                                </div>
                                            </a></td>
                                        <td><span class="badge bg-light d-inline-flex gap-1"><svg
                                    ...
                                    <tr>
                                        <td class="p-3"><a
                                                ...
                                                href="#">
                                                <div>
                                                    <p class="fw-bold mb-0">Cloud Migration</p><small
                                                        class="text-secondary d-block">IT Team</small>
                                                </div>
                                            </a></td>
                                        <td><span class="badge bg-light d-inline-flex gap-1"><svg
                                                    class="icon icon-tabler icon-tabler-loader"
                        ...
                        <nav aria-label="Table pagination">
                            <div
                                ...
                                <div class="small text-muted"><span>Page 1 of 3</span></div>
                                <div class="d-flex justify-content-center align-items-center flex-wrap gap-3">
                                    <div class="d-flex align-items-center gap-2"><label
                                            class="form-label small mb-0">Rows per page</label><select
