    ...
    <div>
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <div class="mb-0 h4"><span>$1,250.00</span></div>
                                    ...
                                    class="icon icon-tabler icon-tabler-trending-up" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center py-3">
                ...
                <div class="btn-group" role="group"><button class="btn btn-light btn-sm" type="button">30
                        Days</button><button class="btn btn-light btn-sm" type="button">60 Days</button><button
                        class="btn btn-primary btn-sm" type="button">90 Days</button></div>
            </div>
            <div class="card-body">
                <div><canvas
        ...
        <div class="row gy-4 row-cols-1 row-cols-lg-2 mb-4">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center pb-3"><button class="btn"
                                type="button"><svg class="bi bi-chevron-left" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <h5 class="mb-0">August 2025</h5><button class="btn" type="button"><svg
                                    class="bi bi-chevron-right" xmlns="http://www.w3.org/2000/svg" width="1em"
                            ...
                            <table class="w-100 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>11</td>
                                        <td>12</td>
                                        <td><span class="badge bg-primary position-absolute translate-middle">13</span>
                                        </td>
                                        <td>14</td>
                                        <td>15</td>
                                        <td>16</td>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form>
                            <div class="d-flex flex-column gap-2"><input class="form-control form-control"
                                    type="email" placeholder="Email"><button class="btn btn-primary"
                        ...
                        <ul class="m-0 p-0">
                            <li class="d-flex align-items-center mb-3">
                                <div class="lh-1 bg-info-subtle rounded-circle p-2 me-3"><svg
                                        class="bi bi-paypal fs-5" xmlns="http://www.w3.org/2000/svg" width="1em"
                                        height="1em" fill="currentColor" viewBox="0 0 16 16">
                                        <path
                            ...
                            <li class="d-flex align-items-center mb-3">
                                <div class="lh-1 bg-success-subtle rounded-circle p-2 me-3"><svg
                                        class="bi bi-credit-card fs-5" xmlns="http://www.w3.org/2000/svg"
                                        width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                        <path
                            ...
                            <li class="d-flex align-items-center">
                                <div class="lh-1 bg-secondary-subtle rounded-circle p-2 me-3"><svg
                                        class="bi bi-bank fs-5" xmlns="http://www.w3.org/2000/svg" width="1em"
                                        height="1em" fill="currentColor" viewBox="0 0 16 16">
                                        <path
                    ...
                    <div class="card-header pb-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="swiper-nav-standalone d-flex" data-bss-swiper-target="#swiper-tips">
                                <div class="swiper-button-prev"><button class="btn btn-light btn-sm me-2"
                                        type="button"><svg class="bi bi-chevron-left"
                                            xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            fill="currentColor" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                                d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0">
                        ...
                        <div class="swiper" id="swiper-tips"
                            ...
                            <div class="swiper-wrapper pb-2">
                                <div class="swiper-slide"><img
                                    ...
                                    <h4>Desert Sands</h4>
                                    <p>Quam rutrum justo consectetur quam, sed congue cursus tincidunt cursus ad. Ligula
                                        ante magna euismod, dui habitasse per etiam. Vehicula dui fringilla egestas
                                        dolor.</p>
                                </div>
                                <div class="swiper-slide"><img
                                        class="img-fluid aspect-ratio-16x9 object-fit-cover rounded-4 w-100 mb-3"
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                        ...
                                        <td class="text-center">
                                            <div class="dropstart"><a class="btn" data-bs-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item"
                                                        href="#"><svg class="bi bi-person me-2"
                                                            xmlns="http://www.w3.org/2000/svg" width="1em"
                                                            height="1em" fill="currentColor" viewBox="0 0 16 16">
                                                            <path
                                    ...
                                    <tr valign="middle">
                                        <td><input type="checkbox" class="form-check-input"></td>
                                        <td><button class="btn btn-link text-start p-0">Terms &amp; Conditions</button>
                                        </td>
                                        <td><span class="badge bg-light">Content Update</span></td>
                                        <td><span class="badge bg-light d-inline-flex gap-1"><svg
                                                    class="bi bi-check-circle-fill text-success"
        ...
        <div class="card">
            <div
                ...
                <form class="position-relative flex-grow-1 flex-shrink-0 flex-xl-grow-0 ms-auto"><input
                        class="form-control pe-4" type="search" placeholder="Search" name="search"><button
                        class="btn border-0 position-absolute top-50 end-0 translate-middle-y" type="submit"><svg
                            class="bi bi-search" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path
                                d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0">
                            </path>
                        </svg></button></form>
                <div class="dropdown"><button class="btn btn-link" data-bs-toggle="dropdown" aria-expanded="false"
                        type="button"><svg class="bi bi-three-dots-vertical" xmlns="http://www.w3.org/2000/svg"
                            width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                            <path
                                d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0">
                            </path>
                        </svg></button>
                    <div class="dropdown-menu dropdown-menu-end shadow"><a class="dropdown-item" href="#">7
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover" style="min-width: 550px;">
                        ...
                        <tbody>
                            <tr valign="middle">
                                <td class="p-3"><a class="text-decoration-none d-flex align-items-center gap-2"
                                        href="#"><img
                                            class="img-fluid aspect-ratio-1x1 object-fit-cover rounded-circle shadow-sm"
                                            src="../assets/img/team/avatar1.jpg" alt="Customer" width="40"
                                            height="40">
                                        <div>
                                    ...
                                    <div class="dropstart"><a class="btn" data-bs-toggle="dropdown"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item"
                                            ...
                                            <div class="dropdown-divider"></div><a class="dropdown-item link-danger"
                                                href="#"><svg class="bi bi-trash2 me-2"
                                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                    fill="currentColor" viewBox="0 0 16 16">
                                                    <path
                                                        d="M14 3a.7.7 0 0 1-.037.225l-1.684 10.104A2 2 0 0 1 10.305 15H5.694a2 2 0 0 1-1.973-1.671L2.037 3.225A.7.7 0 0 1 2 3c0-1.105 2.686-2 6-2s6 .895 6 2M3.215 4.207l1.493 8.957a1 1 0 0 0 .986.836h4.612a1 1 0 0 0 .986-.836l1.493-8.957C11.69 4.689 9.954 5 8 5s-3.69-.311-4.785-.793">
                            ...
                            <tr valign="middle">
                                <td class="p-3"><a class="text-decoration-none d-flex align-items-center gap-2"
                                        href="#"><img
                                            class="img-fluid aspect-ratio-1x1 object-fit-cover rounded-circle shadow-sm"
                                            src="../assets/img/team/avatar2.jpg" alt="Customer" width="40"
                                            height="40">
                                        <div>
                            ...
                            <tr valign="middle">
                                <td class="p-3"><a class="text-decoration-none d-flex align-items-center gap-2"
                                        href="#"><img
                                            class="img-fluid aspect-ratio-1x1 object-fit-cover rounded-circle shadow-sm"
                                            src="../assets/img/team/avatar3.jpg" alt="Customer" width="40"
                                            height="40">
                                        <div>
                                            <p class="fw-bold mb-0">Joanna Prince</p><small
                                                class="text-secondary d-block">Marketing Manager</small>
                            ...
                            <tr valign="middle">
                                <td class="p-3"><a class="text-decoration-none d-flex align-items-center gap-2"
                                        href="#"><img
                                            class="img-fluid aspect-ratio-1x1 object-fit-cover rounded-circle shadow-sm"
                                            src="../assets/img/team/avatar4.jpg" alt="Customer" width="40"
                                            height="40">
                                        <div>
                                            <p class="fw-bold mb-0">Mike Johnson</p><small
                                                class="text-secondary d-block">CTO, Corpy Corp</small>
                                ...
                                <td><span class="badge bg-light d-inline-flex gap-1"><svg
                                            class="bi bi-x-circle-fill text-danger" xmlns="http://www.w3.org/2000/svg"
                                            width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                            <path
                                                d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z">
                                            </path>
                ...
                <nav aria-label="Table pagination">
                    <div
                        ...
                        <div class="text-muted small"><span>Page 1 of 10</span></div>
                        <div class="d-flex justify-content-center align-items-center flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-2"><label class="form-label mb-0 small">Rows per
                                    page</label><select class="form-select-sm w-auto form-select">
                                    <option value="">10</option>
                                    <option value="">25</option>
                                    <option value="">50</option>
                                </select></div>
