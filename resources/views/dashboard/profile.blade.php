<x-dash-layout>
    <x-slot name='title'>Profile - Brand</x-slot>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto"><img class="object-fit-cover border rounded-circle border-3"
                                    src="../assets/img/team/avatar2.jpg" width="120" height="120"
                                    alt="Profile Picture"></div>
                            <div class="col">
                                <h3 class="fw-bold mb-1">John Smith</h3>
                                <p class="text-muted mb-2">Senior Project Manager</p>
                                <div class="d-flex flex-wrap gap-2 mb-3"><span class="badge bg-success">Pro
                                        Member</span><span class="badge bg-light"> 3 years with company </span><span
                                        class="badge bg-light"> Marketing Team </span></div>
                            ...
                            <div class="col-auto"><button class="btn btn-primary" type="button"> Edit Profile </button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-8 mb-4">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold mb-0">About</h5><button class="btn btn-primary btn-sm" type="button">
                            Edit </button>
                    </div>
                    <div class="card-body pt-2">
                        <p class="mb-4">Experienced Project Manager with over 8 years of expertise in leading
                            cross-functional teams and delivering complex digital projects. Passionate about agile
                            methodologies, user-centered design, and building high-performing teams.</p>
                        <div class="row g-3">
                            <div class="col-md-6">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold mb-0">Skills &amp; Expertise</h5><button class="btn btn-primary btn-sm"
                            type="button"> Add </button>
                    </div>
                    <div class="card-body pt-2">
                        <div class="d-flex flex-wrap gap-2"><span
                                class="badge bg-light d-inline-flex gap-1">&nbsp;Project Management</span><span
                                ...
                                class="badge bg-light d-inline-flex gap-1">Strategic Planning</span><span
                                class="badge bg-light d-inline-flex gap-1">Stakeholder Management</span><span
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold mb-0">Recent Projects</h5><a class="btn btn-primary btn-sm" role="button"
                            href="#">View All</a>
                    </div>
                            ...
                            <div class="px-0 py-3 list-group-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="small text-muted mb-2">Complete redesign of company website with
                                            modern UI/UX</p>
                                        <div class="progress mb-2">
                                            <div class="progress-bar bg-info" aria-valuenow="68" aria-valuemin="0"
                                                aria-valuemax="100" style="width: 68%;"><span
                                                    class="visually-hidden">68%</span></div>
                                        </div>
                                        <div class="small text-muted d-flex gap-3"><span> Due: Mar 15,
                                                2026</span><span> 8 members</span><span> 68% complete</span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="px-0 py-3 list-group-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="small text-muted mb-2">Update brand guidelines and create new
                                            marketing materials</p>
                                        <div class="progress mb-2">
                                            <div class="progress-bar bg-info" aria-valuenow="85" aria-valuemin="0"
                                        ...
                                        <div class="small text-muted d-flex gap-3"><span> Due: Feb 28,
                                                2026</span><span> 5 members</span><span> 85% complete</span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="px-0 py-3 list-group-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="small text-muted mb-2">Integrate new CRM system with existing tools
                                        </p>
                                        <div class="progress mb-2">
                                        ...
                                        <div class="small text-muted d-flex gap-3"><span> Completed: Jan 10,
                                                2026</span><span> 6 members</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4 mb-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="d-flex gap-2"><a class="btn btn-outline-primary btn-sm" role="button"
                                href="#"><svg class="bi bi-linkedin" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="list-group list-group-flush">
                            <div class="px-0 py-2 list-group-item">
                                <div class="d-flex align-items-center"><img
                                        ...
                                        src="../assets/img/team/avatar1.jpg" width="36" height="36"
                                        alt="Team member">
                                    <div class="flex-grow-1">
                                        <div class="small fw-semibold"><span>Mike Chen</span></div><small
                            ...
                            <div class="px-0 py-2 list-group-item">
                                <div class="d-flex align-items-center"><img
                                        class="object-fit-cover rounded-circle me-2"
                                        src="../assets/img/team/avatar3.jpg" width="36" height="36"
                                        alt="Team member">
                                    <div class="flex-grow-1">
                                        <div class="small fw-semibold"><span>Emma Wilson</span></div><small
                            ...
                            <div class="px-0 py-2 list-group-item">
                                <div class="d-flex align-items-center"><img
                                        class="object-fit-cover rounded-circle me-2"
                                        src="../assets/img/team/avatar4.jpg" width="36" height="36"
                                        alt="Team member">
                                    <div class="flex-grow-1">
                                        <div class="small fw-semibold"><span>David Lee</span></div><small
                            ...
                            <div class="px-0 py-2 list-group-item">
                                <div class="d-flex align-items-center"><img
                                        class="object-fit-cover rounded-circle me-2"
                                        src="../assets/img/team/avatar5.jpg" width="36" height="36"
                                        alt="Team member">
                                    <div class="flex-grow-1">
                                        <div class="small fw-semibold"><span>Lisa Martinez</span></div><small
